...
func (x *RankCreateRequest) GetRankSystem() *rank.RankSystem_ID {
	if x != nil {
		return x.RankSystem
	}
	return nil
...
func (x *RankConditionAttachRequest) GetRank() *rank.RankSystem_Rank_ID {
	if x != nil {
		return x.Rank
	}
	return nil
...
var file_biconom_admin_rank_v1_rank_proto_goTypes = []interface{}{
	...
	(*rank.RankSystem_Rank_ID)(nil),         // 4: biconom.type.RankSystem.Rank.ID
	(*sort.Sort)(nil),                       // 5: biconom.type.Sort
	(*rank.RankSystem_ID)(nil),              // 6: biconom.type.RankSystem.ID
	(*rank.RankSystem_Rank_ID_Inner)(nil),   // 7: biconom.type.RankSystem.Rank.ID.Inner
	(*condition.Condition_Template_ID)(nil), // 8: biconom.type.Condition.Template.ID
	(*rank.RankSystem_Option)(nil),          // 9: biconom.type.RankSystem.Option
	(*rank.RankSystem_Rank)(nil),            // 10: biconom.type.RankSystem.Rank
	(*rank.RankSystem_Rank_Header)(nil),     // 11: biconom.type.RankSystem.Rank.Header
