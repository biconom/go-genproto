...
type RankSystemClient interface {
	...
	Create(ctx context.Context, in *RankSystemCreateRequest, opts ...grpc.CallOption) (*rank_system.RankSystem, error)
	Publish(ctx context.Context, in *rank_system.RankSystem_ID, opts ...grpc.CallOption) (*rank_system.RankSystem_Header, error)
	Unpublish(ctx context.Context, in *rank_system.RankSystem_ID, opts ...grpc.CallOption) (*rank_system.RankSystem_Header, error)
}
...
func (c *rankSystemClient) Create(ctx context.Context, in *RankSystemCreateRequest, opts ...grpc.CallOption) (*rank_system.RankSystem, error) {
	out := new(rank_system.RankSystem)
...
func (c *rankSystemClient) Publish(ctx context.Context, in *rank_system.RankSystem_ID, opts ...grpc.CallOption) (*rank_system.RankSystem_Header, error) {
	out := new(rank_system.RankSystem_Header)
...
func (c *rankSystemClient) Unpublish(ctx context.Context, in *rank_system.RankSystem_ID, opts ...grpc.CallOption) (*rank_system.RankSystem_Header, error) {
	out := new(rank_system.RankSystem_Header)
...
type RankSystemServer interface {
	...
	Create(context.Context, *RankSystemCreateRequest) (*rank_system.RankSystem, error)
	Publish(context.Context, *rank_system.RankSystem_ID) (*rank_system.RankSystem_Header, error)
	Unpublish(context.Context, *rank_system.RankSystem_ID) (*rank_system.RankSystem_Header, error)
...
func (UnimplementedRankSystemServer) Create(context.Context, *RankSystemCreateRequest) (*rank_system.RankSystem, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedRankSystemServer) Publish(context.Context, *rank_system.RankSystem_ID) (*rank_system.RankSystem_Header, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Publish not implemented")
}
func (UnimplementedRankSystemServer) Unpublish(context.Context, *rank_system.RankSystem_ID) (*rank_system.RankSystem_Header, error) {
...
func _RankSystem_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RankSystemServer).Publish(ctx, req.(*rank_system.RankSystem_ID))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RankSystem_Unpublish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RankSystemServer).Unpublish(ctx, req.(*rank_system.RankSystem_ID))
	}
	return interceptor(ctx, in, info, handler)
}
